...
def test_find_categories_detects_merger() -> None:
    ...
    categories = find_categories("Company announces merger agreement with a strategic partner.")
...
def test_find_categories_does_not_match_merger_from_emergency() -> None:
    ...
    categories = find_categories("Tesla issues emergency recall notice for affected vehicles.")
...
def test_find_categories_detects_institutional_investment() -> None:
    ...
    categories = find_categories("BlackRock makes a strategic investment in XYZ Corporation.")
...
def test_find_categories_does_not_match_internal_investments() -> None:
    ...
    categories = find_categories("Tesla increases investments in AI, robotics, and manufacturing.")
...
def test_find_categories_detects_contract() -> None:
    ...
    categories = find_categories("Company awarded contract for new government infrastructure project.")
...
def test_find_categories_does_not_match_generic_order_language() -> None:
    ...
    categories = find_categories("Court issues emergency order affecting vehicle registrations.")
...
def test_find_categories_detects_multiple_categories() -> None:
    ...
    categories = find_categories("Company reports record revenue and receives FDA approval.")
