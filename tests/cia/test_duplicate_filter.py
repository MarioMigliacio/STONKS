...
def create_article(title: str, url: str) -> NewsArticle:
...
def test_filter_duplicate_articles_removes_matching_titles() -> None:
    ...
    articles = [
        create_article("Tesla Announces New Product", "https://example.com/article-1"),
        create_article("  tesla announces new product  ", "https://example.com/article-2"),
    ]
...
def test_filter_duplicate_articles_removes_matching_urls() -> None:
    ...
    articles = [
        create_article("Tesla Announces New Product", "https://example.com/tesla"),
        create_article("Another Tesla Headline", "https://example.com/tesla"),
    ]
...
def test_filter_duplicate_articles_keeps_empty_urls() -> None:
    ...
    articles = [
        create_article("Tesla Article One", ""),
        create_article("Tesla Article Two", ""),
    ]
...
def test_filter_duplicate_articles_keeps_unique_articles() -> None:
    ...
    articles = [
        create_article("Tesla Announces New Product", "https://example.com/article-1"),
        create_article("Tesla Expands Robotaxi Service", "https://example.com/article-2"),
        create_article("Tesla Reports Quarterly Earnings", "https://example.com/article-3"),
    ]
